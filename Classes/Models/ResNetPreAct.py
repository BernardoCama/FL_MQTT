...
class RESNETPREACT:
    ...
    # Model definition
    def return_model(self, input_shape=None, nb_classes=param.num_classes, layer1_params=(5,64,2), res_layer_params=(3,16,3),
        final_layer_params=None, init='glorot_normal', reg=0.001, use_shortcuts=True):
