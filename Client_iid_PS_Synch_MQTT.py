...
if __name__ == '__main__':
    ...
    if ('requested_clients' in body.keys()) and (client_ not in body['requested_clients']):
        # THIS MESSAGE IS NOT FOR US !
        # I MUST IGNORE THE MESSAGE!! I WILL NOT (!) START THE TRAINING
        print(f'WARNING! The last message from server is NOT designated for me! My ID: {client_}, requested_clients: {body["requested_clients"]}')
        exit(0)
